 ...
 * @version $Revision$
 */
public class TAURDECallableStatement extends TAURDEPreparedStatement {
  //~ Constructors =============================================================
   ...
   * @throws SQLException DOCUMENT ME!
   */
  public Valuta getValuta(Divisa divisa, int parameterIndex)
                   throws SQLException {
    Valuta  result              = null;
    Integer importoNormalizzato = this.getInteger(parameterIndex);
