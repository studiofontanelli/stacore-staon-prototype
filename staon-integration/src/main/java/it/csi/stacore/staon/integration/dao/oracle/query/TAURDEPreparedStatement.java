 ...
 */
public class TAURDEPreparedStatement {
	 ...
	 */
	protected TAURDEPreparedStatement() {
	}
	 ...
	 */
	public TAURDEPreparedStatement(Connection connection, String query) throws SQLException {
		this();
	...
	public void setInt(int position, int aValue) throws SQLException {
		...
		getLogger().debug("[setInt()] - pos: " + position + " Valore impostato: '" + aValue + "'");
	}
	...
	public void setInt(int position, Integer aValue) throws SQLException {
		...
		getLogger().debug("[setInt()] - pos: " + position + " Valore impostato: '" + strMsgValue + "'");
	}
	...
	public static void main(String[] args) {
		BigDecimal bd = NumberUtil.decodeBigDecimalFromTextInput("16,3").multiply(
					new BigDecimal(10));

		System.out.println("" + bd);
		System.out.println(TAURDEPreparedStatement.allineaDx("" + bd, 4, '0'));
		System.out.println(TAURDEPreparedStatement.allineaDx(StringUtils.replace("" + bd,".", ""), 4, '0'));
		System.out.println(StringUtils.leftPad(StringUtils.replace("" + bd,".", ""), 4, '0'));
	}
