...
public class GeneratorPaFiles extends AbstractGenerator {

	public GeneratorPaFiles(String baseSourceDir, String baseOutputDir) {
	...
	public static void main(String[] args) {
		...
		try {
			new GeneratorPaFiles(sourceDir,destDir).generate();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
